...
const Icons = {
  ...
  Tv: () => <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2" d="M3 5h18a1 1 0 011 1v10a1 1 0 01-1 1H3a1 1 0 01-1-1V6a1 1 0 011-1zM8 21h8m-4-4v4" /></svg>,
};
        ...
        <nav className="flex-1 p-4 overflow-y-auto custom-scrollbar">
          ...
          <div className="space-y-1 mb-6">
            ...
            <a
              ...
              className="flex items-center gap-3 px-4 py-2.5 rounded-lg transition-all text-white/70 hover:bg-white/5 hover:text-white"
            >
              <Icons.Tv />
              Modo TV
            </a>
