...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-[#1a0e13] via-[#2b1720] to-[#1a0e13] flex items-center justify-center p-6 relative overflow-hidden">

      {/* EFEITOS DE LUZ NO FUNDO (Círculos borrados) */}
